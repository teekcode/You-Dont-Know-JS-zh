a11b3a3  on 25 Apr 2016
@ascasson ascasson Replace anti-climatic with anticlimactic

<!-- TOC -->

- [You Don't Know JS: Scope & Closures](#you-dont-know-js-scope--closures)
- [Chapter 5: Scope Closure](#chapter-5-scope-closure)
    - [Enlightenment](#enlightenment)
    - [Nitty Gritty（本质）](#nitty-gritty本质)
    - [Now I Can See](#now-i-can-see)
    - [Loops + Closure](#loops--closure)
        - [Block Scoping Revisited](#block-scoping-revisited)
    - [Modules](#modules)
...
一个函数在自己词法域外执行但仍然能够获得词法域的内容，这就是闭包。
