...
- [You Don't Know JS: ES6 & Beyond](#you-dont-know-js-es6--beyond)
- [Chapter 3: Organization](#chapter-3-organization)
    - [Iterators](#iterators)
        - [Interfaces](#interfaces)
            - [IteratorResult](#iteratorresult)
        - [`next()` Iteration](#next-iteration)
        - [Optional: `return(..)` and `throw(..)`](#optional-return-and-throw)
        - [Iterator Loop](#iterator-loop)
        - [Custom Iterators](#custom-iterators)
        - [Iterator Consumption](#iterator-consumption)
    - [Generators](#generators)
        - [Syntax](#syntax)
            - [Executing a Generator](#executing-a-generator)
            - [`yield`](#yield)
            - [`yield *`](#yield-)
        ...
        - [Transpiling a Generator](#transpiling-a-generator)
    ...
    - [Modules](#modules)
        ...
        - [The New Way](#the-new-way)
            - [`export`ing API Members](#exporting-api-members)
            - [`import`ing API Members](#importing-api-members)
        - [Circular Module Dependency](#circular-module-dependency)
        - [Module Loading](#module-loading)
            - [Loading Modules Outside of Modules](#loading-modules-outside-of-modules)
            - [Customized Loading](#customized-loading)
    - [Classes](#classes)
        - [`class`](#class)
        - [`extends` and `super`](#extends-and-super)
            - [There Be `super` Dragons](#there-be-super-dragons)
            - [Subclass Constructor](#subclass-constructor)
            - [`extend`ing Natives](#extending-natives)
        - [`new.target`](#newtarget)
        - [`static`](#static)
            - [`Symbol.species` Constructor Getter](#symbolspecies-constructor-getter)
    - [Review](#review)
...
我认为，在js中模块是代码组织中最重要的这个观点一点都不夸张。
...
在import和export的语法上，有很多细节，我们要来看下。
...
import和export必须在最上层作用域上，而不能放在条件语句中。
