...
- [Chapter 2: `this` All Makes Sense Now!](#chapter-2-this-all-makes-sense-now)
    ...
    - [Nothing But Rules](#nothing-but-rules)
        ...
        - [Implicit Binding(隐式绑定)](#implicit-binding隐式绑定)
            - [Implicitly Lost](#implicitly-lost)
        - [Explicit Binding](#explicit-binding)
            - [Hard Binding](#hard-binding)
            - [API Call "Contexts"](#api-call-contexts)
        - [`new` Binding](#new-binding)
    - [Everything In Orde(this顺序)](#everything-in-ordethis顺序)
...
注意这里和前面提到的global object对应的对象相区别。
