...
- [Chapter 6: Behavior Delegation](#chapter-6-behavior-delegation)
    - [Towards Delegation-Oriented Design](#towards-delegation-oriented-design)
        ...
        - [Delegation Theory](#delegation-theory)
            - [Mutual Delegation (Disallowed)](#mutual-delegation-disallowed)
            - [Debugged](#debugged)
        - [Mental Models Compared](#mental-models-compared)
    - [Classes vs. Objects](#classes-vs-objects)
        - [Widget "Classes"](#widget-classes)
            - [ES6 `class` sugar](#es6-class-sugar)
        - [Delegating Widget Objects](#delegating-widget-objects)
    - [Simpler Design](#simpler-design)
        - [De-class-ified](#de-class-ified)
...
1 In other words, the actual mechanism, the essence of what's important to the functionality we can leverage in JavaScript, is **all about objects being linked to other objects.**
...
要接受行为代理设计模式，我们要改变我们以前基于类和继承的想法，这将是一个挑战。
...
基于类的设计要求你进行抽象。
译者注：其实抽象这个概念很重要，函数也需要，当然，js中函数和类没有那么明显的区别。
...
### Delegation Theory
代理理论
首先怎么理解，代理说明没有，没有就需要找人代理，那怎么找，通过`[[prototype]]`!
