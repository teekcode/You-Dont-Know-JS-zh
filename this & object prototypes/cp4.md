cb5021a  on 15 Feb 2016
@ncpierson ncpierson fix grammar in "this & object prototypes" chap. 4
...
- [Chapter 4: Mixing (Up) "Class" Objects](#chapter-4-mixing-up-class-objects)
    ...
    - [Mixins](#mixins)
        - [Explicit Mixins](#explicit-mixins)
            - ["Polymorphism" Revisited](#polymorphism-revisited)
            - [Mixing Copies](#mixing-copies)
            - [Parasitic Inheritance](#parasitic-inheritance)
        - [Implicit Mixins](#implicit-mixins)
...
因为classes只是一种设计模式，所以一个语言有没有并不重要，都能写出来。
...
因为很多人都要这么写，所以我们接下来要说如何维持这种幻觉，并且忍受将会遇到的痛楚。
