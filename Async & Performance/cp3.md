...
再上一章，我们提到了使用callbacks的两种缺点：写法缺乏连续感和乏可信度。
...
我们很难从使用api上看出一个人是否真的理解了promise，所以，我要来解释下。
...
The behavior here only works if your application calls for the button to be click